...
describe('developer workbench styles', () => {
  it('scopes palette, interaction, status, focus, and motion rules to the marker', async () => {
    ...
    expect(css).toContain('--dsw-alias-workbench-status-running')
    expect(css).toContain('data-dsh-workbench-status-track')
